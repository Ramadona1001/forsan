    ...
    <div class="container">
        <div class="footer__wrapper">
            <div class="footer__col footer__info">
                <div class="footer__logo">
                    <img src="{{ asset('images/logo/logo-w.webp') }}" alt="img">
                </div>
                <p class="footer__desc">
                    {{ __('general.footer_description') }}
                </p>

            </div>
            <div class="footer__col footer__links">
                <h3 class="footer__head">{{ __('general.quick_links') }}</h3>
                ...
                <ul class="mobile_links">
                    ...
                    <li><a href="{{ route('products.index') }}">
                            <p>{{ __('general.products') }}</p>

                        </a></li>
                    <li><a href="{{ route('stores.index') }}">
                            <p>{{ __('general.stores') }}</p>
                    ...
                    <li><a href="{{ route('contact') }}">
                            <p>{{ __('general.contact_us') }}</p>

                        </a></li>
                </ul>
            </div>
            <div class="footer__col footer__links">
                <h3 class="footer__head">{{ __('general.newsletter') }}</h3>

                <ul class="mobile_links">
                    <li>
                        <p>{{ __('general.newsletter_desc') }}</p>
            ...
            <div class="footer__col footer__links">
                <h3 class="footer__head">{{ __('general.contact_us') }}</h3>
                ...
                <ul class="mobile_links">
                    ...
                    <li>
                        <a href="mailto:info@knights.com">
                            <p>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none">
        ...
        <div class="footer__copyright">
            <p>
                ...
                <a class="mx-2" href="https://ocoda.com">{{ __('general.ocoda') }}</a>

                {{ date('Y') }}
            </p>
            <img class="img-fluid" src="{{ asset('images/icons/Payment.svg') }}" alt="img">
        </div>
    </div>
</footer>