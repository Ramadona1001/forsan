...
@section('title', __('profile.add_horse') . ' - ' . config('app.name'))
                ...
                <div class="col-xl-8">
                    <div class="main-section">
                        <div class="main-section__header mb-4">
                            <h3 class="section-head line"><i class="bi bi-plus-circle me-2"></i>{{ __('profile.add_new_horse') }}</h3>
                        </div>

                        <form class="main-form" action="{{ route('profile.horses.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control @error('name') is-invalid @enderror" id="name" type="text" name="name" value="{{ old('name') }}" placeholder="{{ __('profile.horse_name') }}" required>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control @error('breed') is-invalid @enderror" id="breed" type="text" name="breed" value="{{ old('breed') }}" placeholder="{{ __('profile.breed') }}">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control @error('color') is-invalid @enderror" id="color" type="text" name="color" value="{{ old('color') }}" placeholder="{{ __('profile.color') }}">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select @error('gender') is-invalid @enderror" id="gender" name="gender">
                                                    ...
                                                    <option value="male" {{ old('gender') == 'male' ? 'selected' : '' }}>{{ __('profile.male') }}</option>
                                                    <option value="female" {{ old('gender') == 'female' ? 'selected' : '' }}>{{ __('profile.female') }}</option>
                                                </select>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="4" placeholder="{{ __('profile.description') }}">{{ old('description') }}</textarea>
                                ...
                                <div class="main-form custom-form">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="is_for_sale" name="is_for_sale" value="1" {{ old('is_for_sale') ? 'checked' : '' }}>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="is_for_rent" name="is_for_rent" value="1" {{ old('is_for_rent') ? 'checked' : '' }}>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control @error('price') is-invalid @enderror" id="price" type="number" name="price" value="{{ old('price') }}" step="0.01" placeholder="{{ __('profile.price') }}">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <small class="text-muted d-block mt-1">{{ __('profile.main_image_hint') }}</small>
                            ...
                            <div class="d-flex flex-wrap gap-2 mt-4">
                                <button type="submit" class="main-button main-primary fill">
                                    <i class="bi bi-check me-1"></i>{{ __('profile.save_horse') }}
                                </button>
