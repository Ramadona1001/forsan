...
@section('title', __('general.stores') . ' - ' . config('app.name'))
        ...
        <div class="container">
            <div class="main-banner ">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h3 class="main-banner__head">{{ __('general.stores_banner_heading') }}</h3>
                        <p class="main-banner__sale">{{ __('general.stores_banner_sale') }}</p>
                        <!-- start breadcrumb-->
                        <nav class="breadcrumb-parent" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('home') }}">{{ __('general.home') }}</a></li>
                                <li class="breadcrumb-item active">{{ __('general.stores') }}</li>
                            </ol>
                        </nav>
                        <!-- end breadcrumb-->
                    </div>
        ...
        <div class="container">
                            ...
                            <div class="main-card">
                                ...
                                <div class="main-card__content">
                                    ...
                                    <button class="main-button main-primary fill"
                                        onclick="window.location.href='{{ route('stores.show', $store) }}'">{{ __('general.stores_enter_store') }}</button>
                                </div>
                            </div>
                        </div>
                    @endforeach
            ...
            @else
                <div class="alert alert-info text-center">
                    <i class="bi bi-info-circle me-2"></i>{{ __('general.no_stores') }}
                </div>
            @endif
        </div>
    </section>
